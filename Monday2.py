...
def load_data():
    activity_df = pd.read_csv("/Users/anastasia/Downloads/sdr_activity_metrics_2024_more_variance.csv")
    SDR_df = pd.read_csv("/Users/anastasia/Downloads/sdr_bizdev_data_2024_refined (1).csv")
